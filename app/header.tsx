    ...
    return ( 
        <header className="flex fixed w-full items-center bg-gradient-to-b from-cyan-400 to-blue-800 text-white p-5 animate-movingBg">
            ...
            <form className='flex w-1/2 ml-auto h-1/3'>
                ...
                <button className="flex bg-black bg-opacity-30 hover:bg-blue-700 hover:bg-opacity-30 text-white font-bold p-3  outline-none  rounded-r-xl"><IoSend className='h-10 w-20'/></button>
            </form>
