...
{/*          <div className='flex flex-col w-1/2 h-full justify-center items-center'>
            ...
            <div className="flex flex-col h-1/2 w-1/2 justify-center mt-auto mb-auto">
                <form className="flex flex-col w-full bg-gradient-to-b from-cyan-800 to-blue-800 items-center rounded-xl h-3/4 justify-center gap-4 animate-movingBg" onSubmit={(e)=>{e.preventDefault();location.href='/next'}}>
                    ...
                    <span className='flex w-1/2 items-center  justify-center bg-black bg-opacity-30 rounded-xl'>
                        ...
                        <input className="w-full text-white font-semibold text-2xl py-4 pl-2 bg-transparent  rounded-xl outline-none" placeholder="Username" id='username'/>
                    </span>
                 {/*}   <span className='flex w-1/2  bg-black bg-opacity-30 rounded-xl'>
                    ...
                    <button className="w-1/3 text-xl bg-gradient-to-b from-cyan-600 to-blue-500 hover:bg-gradient-to-b hover:from-cyan-400 hover:to-blue-600 hover:scale-105 transition-transform  py-4 rounded-xl text-center text-white font-semibold " onClick={()=>redirect('/next')}>
                        Next
                    </button>
                </form>
            </div>
